...
#ifdef XASH_BUILD
	// Xash3D FWGS: vgui_support doesn't properly translate VGUI panel
	// coordinates through the GL modelview for direct TriAPI rendering.
	// Set up explicit orthographic projection with absolute screen coords.
	int absX = 0, absY = 0;
	localToScreen(absX, absY);
